...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-cinnamon-theme-vimix"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-cinnamon-theme-vimix/iso-profile
"
echo
